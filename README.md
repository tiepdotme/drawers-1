...
### License
The content of this project itself, all illustrations & design works are © Yves JPL Capelle / [alternatyves outc.](https://alternatyves.com) / SOFAM. The underlying source code used to format and display that content (the theme) is available as open source under the terms of theunder the [MIT License](https://opensource.org/licenses/MIT).
