...
- Templates
---
<a href="https://gum.co/storyboard_template_185x1_pages"><img src="/images/Apple-Pages-storyboard-template-for-1.85x1-ratio-films_Avenir-Light-10pt_DIN-A4_vertical-sheet_overview.png"/><br/><br/>

{% include gumroad-overlay.html id="storyboard_template_185x1_pages" %}

storyboard template layout for films in 1.85:1 aspect ratio that you can edit with [Pages](https://www.apple.com/pages/), the free Apple productivity app.

With three master pages to format your layout, this template is ideal to design quick storyboard layouts.
...
This template will help you create neat storyboards layouts and save up pre production time.
